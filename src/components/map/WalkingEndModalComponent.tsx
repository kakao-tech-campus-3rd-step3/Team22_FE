...
export default function WalkingEndModalComponent(props: {
  ...
  const { totalDistance, elapsedTime, setEndModal } = props;
  ...
  return (
    <div className="absolute inset-0 bg-black bg-opacity-50 flex justify-center items-center z-20">
      <div className="bg-zinc-800 p-6 rounded-lg shadow-xl text-center">
        ...
        <p className="mb-2">{(totalDistance / 1000).toFixed(2)} km</p>
        <p className="mb-6">{formatTime(elapsedTime)}</p>
        <div className="flex justify-center gap-4">
          <button className="bg-red-500 hover:bg-red-600 px-4 py-2 rounded cursor-pointer">종료하기</button>
          <button
